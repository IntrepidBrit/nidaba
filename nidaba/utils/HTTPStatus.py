"""
This class is basically directly lifted from http.HTTPStatus. But to import it would force a Python 3.5 requirement on
other developers. Also, by defining it here we can extend it to give it some features we can find useful in the
rest of the project
